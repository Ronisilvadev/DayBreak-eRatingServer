...
<head>
	...
	<title></title>
	<html:javascript formName="/renameRole"/>
</head>

<body bgcolor="#ffffff">
		<html:form action="renameRole.do" method="post" onsubmit="return validateRenameRoleForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.roleOperation.renameRole.title"/></td>
			</tr>
			<tr height="30px">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleOperation.renameRole.rename"/>：
				 </td>
				 <td class="t_border_r" align="left">
				 	<input name="rename" type="text" style="width:230px" /> 
				 </td>
			</tr>
			<tr height="30px">
