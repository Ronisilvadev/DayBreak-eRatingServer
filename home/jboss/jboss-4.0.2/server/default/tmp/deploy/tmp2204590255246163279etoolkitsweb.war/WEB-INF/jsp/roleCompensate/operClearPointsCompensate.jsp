...
<body bgcolor="#ffffff">
		...
		<gmweb:createCompenOperButton operType="${requestScope.oper}" actionName="roleCompensate" operatorName="${requestScope.ClearPointsCompensate.OPERATOR_NAME}" passportName="${sessionScope.userInfo.passportName}" compensateId="${requestScope.compensateId}" methodType="ClearPointsCompensate" />
