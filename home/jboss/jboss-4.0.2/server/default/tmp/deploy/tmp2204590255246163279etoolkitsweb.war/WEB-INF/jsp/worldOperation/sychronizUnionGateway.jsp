...
//						frm.deleteButton.disabled = false; 
	...
	<body bgcolor="#ffffff">
		<form action="sychronousUnionGatewayPlan.do" method="post">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<td colspan="10" align="center" class="t_border">
					<input type="button" onclick="window.location.href='showUnionGatewayPlanList.do'" value="<bean:message bundle="pageResources" key="page.tag.CreateCompenOperButtonTag.tag1"/>" />&nbsp;&nbsp;
					...
					<input name="subButton" type="submit" value="<bean:message bundle="pageResources" key="page.worldOperator.unionGatewayPlan.title"/>"/>&nbsp;&nbsp;
					<input name="taskName" type="hidden" value="${requestScope.taskName}"/>
				</td>
			</tr>
		</table>
		</form>		
