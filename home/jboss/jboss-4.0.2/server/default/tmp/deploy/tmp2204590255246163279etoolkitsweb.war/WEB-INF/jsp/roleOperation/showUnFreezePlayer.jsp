...
<body bgcolor="#ffffff">
	<form action="unFreezePlayer.do" method="post" onsubmit="return check();">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.roleOperation.showUnFreezePlayer.title"/></td>
			</tr>
			<tr height="30px">
			...
			<tr height="30px">
				 <td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleOperation.showUnFreezePlayer.freezeReason"/>
				 </td>
				 <td class="t_border_r" align="left">
