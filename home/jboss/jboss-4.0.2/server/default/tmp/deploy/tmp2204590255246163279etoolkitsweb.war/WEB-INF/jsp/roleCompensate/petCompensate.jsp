...
<html>
	...
	<body bgcolor="#ffffff">
		...
		<form name="pageForm" action="${requestScope.operType }.do" method="post">
			<table width="90%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr height="30px">
					<td colspan="10" align="left">
						<gmweb:createCompenTitleButton operType="${requestScope.operType}" actionName="roleCompensate" methodType="PetCompensate" />
					</td>
				</tr>
				<tr>
					...
					<tr height="23px">
						<td width="10%" align="center" class="t_border_l">
							<input name="compensateId" type="checkbox" value="${petCompensate.compensateId
							 }" onclick="uncheckAll(document.forms[0]);" <c:if test="${requestScope.apprType != 'batchFirstApprPetCompensate' and requestScope.apprType != 'batchSecondApprPetCompensate' }">disabled</c:if> />
						</td>
						<td align="center" class="t_border_l">
							${status.index + 1 }
						</td>
						...
						<td align="center" class="t_border_l">
							${petCompensate.roleName }
						</td>
						<td align="center" class="t_border_l">
							${petCompensate.gatewayId }
						</td>
						<td align="center" class="t_border_l">
							${petCompensate.operatorName }
						</td>
						<td align="center" class="t_border_l">
						...
						<td align="center" class="t_border_r">
							...
							<gmweb:createCompenOperLink operType="${requestScope.operType}" actionName="roleCompensate" methodType="PetCompensate" compensateId="${petCompensate.compensateId}"/>
						</td>
					</tr>
				</c:forEach>
				<tr height="30px">
			...
			<c:if test="${requestScope.operType == 'showPetCompensate' }">
			<tr height="30px">
				<td colspan="10" align="left">
					<input type="button" value="<bean:message bundle="pageResources" key="page.roleCompensate.awardCompensate.createAwardCompensate"/>" onclick="window.location.href='showCreatePetCompensate.do'" />
				</td>
			</tr>
			</c:if>
			<c:if test="${requestScope.apprType == 'batchFirstApprPetCompensate' or requestScope.apprType == 'batchSecondApprPetCompensate' }">
			<tr height="30px">
