...
<body bgcolor="#ffffff">
	<c:if test="${not empty requestScope.gatewayList }">
		<form action="getCorpsTotalNew.do" method="post" onsubmit="return validateCorpsTotalForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.playerQuery.corpsTotalNew.title"/></td>
			</tr>
			<tr height="30px">
	...
	<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
		...
		<tr>
			<td colspan="20" align="center" class="t_head"><bean:message bundle="pageResources" key="page.playerQuery.corpsTotalNew.title"/>(${corpsTotalSize})</td>
		</tr>
