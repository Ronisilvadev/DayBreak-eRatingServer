...
<body bgcolor="#ffffff">
	<form action="<c:if test="${requestScope.oper == 'firstAppr' }">firstApprClosePassCard.do</c:if>
		<c:if test="${requestScope.oper == 'secondAppr' }">secondApprClosePassCard.do</c:if>" method="post">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr height="30px">
				<td align="center" colspan="2"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.roleOperation.operClosePassCard.title3"/></td>
			</tr>
			<tr height="23px">
	...
	<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr height="23px">
				...
				<td align="center" class="t_border_r"><c:out value="${requestScope.closePassCard.passportName }"/></td>
			</tr>
			<tr height="23px">
				...
				<td align="center" class="t_border_r"><c:out value="${requestScope.closePassCard.playerRealName }"/></td>
			</tr>
			<tr height="23px">
