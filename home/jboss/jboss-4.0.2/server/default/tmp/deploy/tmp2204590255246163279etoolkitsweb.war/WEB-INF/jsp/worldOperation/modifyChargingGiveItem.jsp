...
<body bgcolor="#ffffff">
	...
	<form action="modifyChargingGiveItem.do" method="post" onsubmit="return check();">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				<td align="center" class="t_head" colspan="3">
					<bean:message bundle="pageResources" key="page.worldOperation.modifyChargingGiveItem.title"/>
				</td>
			</tr>
			<tr>
			<td width="25%" class="t_border_l" align="right" ><bean:message bundle="pageResources" key="page.worldOperation.chargingGiveItemDetail.itemCode"/>
				 ...
				 <td class="t_border_r" align="left">
				 	${requestScope.itemCode}
				 	<input name="itemCode" type="hidden" value="${requestScope.itemCode}" style="width:200px" />
				 </td>
			</tr>
			<tr>
			<td width="25%" class="t_border_l" align="right" ><bean:message bundle="pageResources" key="page.worldOperation.productInfo.item_name"/>
				 </td>
				 <td class="t_border_r" align="left">
				 	<input name="itemName" type="text" value="${requestScope.itemName}" style="width:200px" />
				 </td>
			</tr>
			<tr>
			...
			<tr height="30px">
				<td width="25%" class="t_border_l" align="right" ><bean:message bundle="pageResources" key="page.worldOperation.addActivityPackage.activityType"/>
				 ...
				 <td class="t_border_r" align="left">
				 	${requestScope.activityType}
				 	<input name="activityType" type="hidden" value="${requestScope.activityType}" />
				 </td>
			</tr>
			<tr>
			...
			<tr height="30px">
				<td width="25%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.worldOperation.common.startTime"/>
				 ...
				 <td class="t_border_r" align="left">
				 	<input name="beginTime" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" style="width:200px" value="<fmt:formatDate value="${ requestScope.beginTime}" pattern="yyyy-MM-dd HH:mm"/>" />
				 	<br />
			...
			<tr height="30px">
				<td width="25%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.worldOperation.common.endTime"/>
				 ...
				 <td class="t_border_r" align="left">
				 	<input name="endTime" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" style="width:200px" value="<fmt:formatDate value="${ requestScope.endTime}" pattern="yyyy-MM-dd HH:mm"/>" />
				 	<br />
				 	<bean:message bundle="pageResources" key="page.worldOperation.common.timeInfo"/>
				 </td>
			</tr>
			<tr height="30px">
				<td width="25%" class="t_border_l" align="right" ><bean:message bundle="pageResources" key="page.worldOperation.modifyChargingGiveItem.costPoint"/>
				 </td>
				 <td class="t_border_r" align="left">
			...
			<tr height="30px">
				<td width="25%" class="t_border_l" align="right" ><bean:message bundle="pageResources" key="page.worldOperation.modifyChargingGiveItem.pointType"/>
				 </td>
				 <td class="t_border_r" align="left">
			...
			<tr height="30px">
				<td width="25%" class="t_border_l" align="right" ><bean:message bundle="pageResources" key="page.worldOperation.modifyChargingGiveItem.sendItemNum"/>
				 </td>
				 <td class="t_border_r" align="left">
