...
<head>
	...
	<title></title>
	<html:javascript formName="/modifyGateway"/>
</head>


<body bgcolor="#ffffff">
	<html:form action="modifyGateway.do" method="post" onsubmit="return validateGatewayForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30px"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.dictionaryConfig.modifyGateway.title"/></td>
			</tr>
			<tr>
