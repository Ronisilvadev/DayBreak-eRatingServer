...
<body bgcolor="#ffffff" onload="disableInput();">
	<form action="addNews.do" method="post" onsubmit="return check();">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				<td align="center" class="t_head" colspan="3"><bean:message bundle="pageResources" key="page.worldOperation.addNews.title"/></td>
			</tr>
			<tr>
				...
				<td width="25%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervals"/>
				 ...
				 <td class="t_border_r" align="left" colspan="2">
				 	<select name="intervals">
						<option value="30"><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervalsValue1"/></option>
						<option value="60"><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervalsValue2"/></option>
						<option value="120"><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervalsValue3"/></option>
						<option value="300" selected><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervalsValue4"/></option>
						<option value="600"><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervalsValue5"/></option>
						<option value="1200"><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervalsValue6"/></option>
						<option value="1800"><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervalsValue7"/></option>
						<option value="3600"><bean:message bundle="pageResources" key="page.worldOperation.addBulletin.intervalsValue8"/></option>
					</select>
				 </td>
			</tr>
			<tr height="30px">
				<td width="25%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.worldOperation.issueNews.content"/>
				 </td>
