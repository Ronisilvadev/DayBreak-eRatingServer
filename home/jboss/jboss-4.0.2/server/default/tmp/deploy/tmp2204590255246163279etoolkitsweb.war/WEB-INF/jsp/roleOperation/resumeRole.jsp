	...
	<script type="text/javaScript">
			...
			function check(){
				...
				if ( document.forms[0].description.value == "" || document.forms[0].description.value  == null){
					  ...
					  return confirm('<bean:message bundle="pageResources" key="page.roleOperation.queryResumeRole.alert"/>');
				}
			}
...
<body bgcolor="#ffffff">
	<form action="resumeRole.do" method="post" onsubmit="return check();">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr height="30px">
				...
				<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleOperation.queryResumeRole.resumeReason"/>
				 </td>
				 <td class="t_border_r" align="left">
				 	<SELECT name="reason">
			...
			<tr height="30px">
				<td class="t_border_r" style="border-bottom:#AEAEB0 1px solid;" align="center" colspan="2">
					...
					<input type="submit" value=" <bean:message bundle="pageResources" key="page.roleOperation.queryResumeRole.resume"/> " />&nbsp;&nbsp;
					<input type="button" value=" <bean:message bundle="pageResources" key="page.roleOperation.common.back"/> " onclick="window.location.href='showQueryResumeRole.do'"/>
				</td>
			</tr>
		</table>
	</form>
