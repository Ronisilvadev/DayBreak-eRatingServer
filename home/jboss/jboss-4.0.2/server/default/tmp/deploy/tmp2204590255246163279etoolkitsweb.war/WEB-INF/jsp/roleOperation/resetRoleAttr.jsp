...
<head>
	...
	<title></title>
	<html:javascript formName="/resetRoleAttr"/>
</head>

<body bgcolor="#ffffff">
		<html:form action="resetRoleAttr.do" method="post" onsubmit="return validateResetRoleAttrForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.roleOperation.resetRoleAttr.title"/></td>
			</tr>
			<tr height="30px">
				...
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.common.type"/>：
				 ...
				 <td class="t_border_r" align="left">
				 	<select name="type" style="width:150px">
				  		<option value="0">0-<bean:message bundle="pageResources" key="page.roleOperation.resetRoleAttr.type0"/></option>
				  		<option value="1">1-<bean:message bundle="pageResources" key="page.roleOperation.resetRoleAttr.type1"/></option>
				  		<option value="2">2-<bean:message bundle="pageResources" key="page.roleOperation.resetRoleAttr.type2"/></option>
				  	</select>
				 </td>
			</tr>
			<tr height="30px">
