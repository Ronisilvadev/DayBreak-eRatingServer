...
<script type="text/javaScript">
	...
	function onwindowLoadSelectGameId (){
		var name = 'gameId' ; 
		var cookies = document.cookie ;
		var co_index = cookies.indexOf(name) ;
		var end_index = cookies.indexOf(';',co_index+name.length) ;
		var cookieValue = '0' ;
		...
		if(co_index != -1 ){
			...
			cookieValue = unescape(document.cookie.substring(co_index+name.length+1, end_index)) ; 	
		}
		if(cookieValue!='0') {
			document.LoginForm.gameId.value=cookieValue ;
		}
	}
...
<body onload="onwindowLoadSelectGameId () ;">
<center>
...
<div align="center">
	<a href="instancyBulletin.do?method=showLogin&login"><bean:message bundle="pageResources" key="page.login.insLlogin"/></a>
</div>
<div align="center">
