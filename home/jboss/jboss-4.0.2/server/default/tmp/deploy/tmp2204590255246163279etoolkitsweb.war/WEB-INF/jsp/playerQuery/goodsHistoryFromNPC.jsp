...
<head>
  ...
  <body bgcolor="#ffffff">
  <html:form action="GoodsHistoryFromNPC.do" method="post"> 
	<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
		<tr height="30px">
			<td colspan="6" align="center" ></td>
		</tr>
		<tr>
			<td colspan="6" align="center" class="t_head"><bean:message bundle="pageResources" key="page.playerQuery.goodsHistoryFromNPC.title"/> </td>
		</tr>
		...
		<c:if test="${not empty requestScope.roleLog }">
			<c:forEach items="${requestScope.roleLog.list}" var="goodsHistoryFromNPC" varStatus="status">
				<tr height="23px" class="h_CDE4F6">
					<td align="center" class="t_border_l">${status.index + 1 }</td>
					<td align="center" class="t_border_l">${goodsHistoryFromNPC.itemId }</td>
					<td align="center" class="t_border_l">${goodsHistoryFromNPC.npcName }</td>
					<td align="center" class="t_border_l">${goodsHistoryFromNPC.itemName }</td>
					<td align="center" class="t_border_l">${goodsHistoryFromNPC.itemNum }</td>
					<td align="center" class="t_border_l">${goodsHistoryFromNPC.time }</td>
				</tr>
			</c:forEach>
		</c:if>
		<tr height="30px">
