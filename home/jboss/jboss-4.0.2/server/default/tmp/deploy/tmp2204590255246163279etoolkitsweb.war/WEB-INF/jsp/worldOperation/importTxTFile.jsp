...
<html>
  <head><link href="css/main.css" rel="stylesheet" type="text/css" />
	...
	<script language="javascript">
		function onfileChange (val){
			if(val.value.indexOf(".txt")!=val.value.length-4){
				alert("<bean:message bundle="pageResources" key="page.worldoperaction.importtxtfile.extMatch"/>") ;
  ...
  <body bgcolor="#ffffff">
	 <form action="ImportTxTFile.do" method="post" enctype="multipart/form-data">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				<td colspan="2" align="center" class="t_head">
					<bean:message bundle="pageResources" key="page.worldoperaction.importtxtfile.tile"/>
				</td>
			</tr>
			<tr height="23px">
