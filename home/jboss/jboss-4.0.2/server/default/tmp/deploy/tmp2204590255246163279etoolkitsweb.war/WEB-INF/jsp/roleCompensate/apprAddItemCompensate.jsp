...
<body bgcolor="#ffffff">
	<form action="<c:if test="${requestScope.oper == 'firstAppr' }">firstApprAddItemCompensate</c:if>
		<c:if test="${requestScope.oper == 'secondAppr' }">secondApprAddItemCompensate</c:if>.do" method="post">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr height="30px">
				<td align="center" colspan="2"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.roleCompensate.AddItem.title"/></td>
			</tr>
			<tr height="23px">
		...
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr height="23px">
				...
				<td align="center" class="t_border_r">${requestScope.AddItemCompensate.BIND }</td>
			</tr>
			<tr height="23px">
				...
				<td align="center" class="t_border_r">${requestScope.AddItemCompensate.REASON }</td>
			</tr>
			<tr height="23px">
