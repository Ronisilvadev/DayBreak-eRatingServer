...
<body bgcolor="#ffffff">
	<form action="kickRole2.do" method="post" onsubmit="return check();">
		...
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<tr>
					<td colspan="7" align="center" class="t_head"><bean:message bundle="pageResources" key="page.roleOperation.common.playerInfo5"/> "${roleName }" <bean:message bundle="pageResources" key="page.roleOperation.common.playerInfo6"/></td>
				</tr>
				...
				<tr height="23px">
					...
					<td align="center" class="t_border_r">${kickOffLog.operatorName }</td>
				</tr>
				</c:forEach>
				</c:if>
				<tr height="5px">
