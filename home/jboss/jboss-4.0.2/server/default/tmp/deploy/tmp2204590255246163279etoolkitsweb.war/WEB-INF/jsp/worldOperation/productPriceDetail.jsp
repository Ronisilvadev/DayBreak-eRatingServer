...
<body bgcolor="#ffffff">
	<form action="stopSettingExp.do" method="post">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				<td align="center" class="t_head" colspan="6"><bean:message bundle="pageResources" key="page.worldOperation.productPriceDetail.title"/></td>
			</tr>
			...
			<c:forEach items="${requestScope.productPriceDetailList}" var="productPriceDetail" varStatus="status">
			
			<tr height="23px">
				<td align="center" class="t_border_l">
					${productPriceDetail.priceId}
				</td>
				<td align="center" class="t_border_l">
					${productPriceDetail.gatewayId}
				</td>
				<td align="center" class="t_border_l">
					${productPriceDetail.serverId}
				</td>
				<td align="center" class="t_border_l">
					<fmt:formatDate value="${productPriceDetail.executiveTime}" pattern="yyyy-MM-dd HH:mm:ss" />&nbsp;
				</td>
				<td align="center" class="t_border_l">
					<gmweb:bulletinAndExpState2Text state="${productPriceDetail.state}" />
				</td>
				<td align="center" class="t_border_r">
					<fmt:formatDate value="${productPriceDetail.stopTime}" pattern="yyyy-MM-dd HH:mm:ss" />&nbsp;
				</td>
			</tr>
