...
<html>
	...
	<head>
		...
		<script type="text/javaScript">
			...
			{ 
				frm.action = "${requestScope.apprType}.do?changeType=${requestScope.changeType}";
				frm.method = "post";
				frm.submit();
			}
	...
	<body bgcolor="#ffffff">
		...
		<form name="pageForm" action="${requestScope.operType }.do?changeType=${requestScope.changeType }" method="post">
			<table width="90%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr height="30px">
					<td colspan="11" align="left">
						<gmweb:createCompenTitleButton operType="${requestScope.operType}" changeType="${requestScope.changeType }" actionName="roleCompensate" methodType="PointCompensate" />
					</td>
				</tr>
				<tr>
				...
				<tr height="23px" class="h_CDE4F6">
					...
					<td align="center" class="t_border_l">
						<bean:message bundle="pageResources" key="page.roleCompensate.pointCompensate.roleName"/>
					</td>
					<td align="center" class="t_border_l">
						<bean:message bundle="pageResources" key="page.roleCompensate.pointCompensate.gatewayId"/>
					</td>
					<td align="center" class="t_border_l">
				...
				<c:forEach items="${requestScope.pageInfo.infoList}" var="pointCompensate" varStatus="status">
					<tr height="23px">
						<td width="10%" align="center" class="t_border_l">
							<input name="compensateId" type="checkbox" value="${pointCompensate.changeId }" onclick="uncheckAll(document.forms[0]);" <c:if test="${requestScope.apprType != 'batchFirstApprPointCompensate' and requestScope.apprType != 'batchSecondApprPointCompensate' }">disabled</c:if> />
						</td>
						<td align="center" class="t_border_l">
							${status.index + 1 }
						</td>
						<td align="center" class="t_border_l">
							${pointCompensate.passportName }
						</td>
						<td align="center" class="t_border_l">
							${pointCompensate.roleName }
						</td>
						<td align="center" class="t_border_l">
							${pointCompensate.gatewayId }
						</td>
						<td align="center" class="t_border_l">
							${pointCompensate.changeAmount }
						</td>
						<td align="center" class="t_border_l">
							${pointCompensate.operatorName }
						</td>
						<td align="center" class="t_border_l">
							<fmt:formatDate value="${pointCompensate.insertTime }"
								pattern="yyyy-MM-dd HH:mm:ss" />
						</td>
						<td align="center" class="t_border_l">
							${pointCompensate.reason }
						</td>
						<td align="center" class="t_border_l">
							<gmweb:approvalResult2Text approvalResult="${pointCompensate.approvalResult}" />
						</td>
						<td align="center" class="t_border_r">
							<gmweb:createCompenOperLink operType="${requestScope.operType}" changeType="${requestScope.changeType }" actionName="roleCompensate" methodType="PointCompensate" compensateId="${pointCompensate.changeId}"/>
						</td>
					</tr>
				</c:forEach>
				<tr height="30px">
			...
			<c:if test="${requestScope.operType == 'showPointCompensate' }">
			<tr height="30px">
				<td colspan="11" align="left">
					<input type="button" value="<bean:message bundle="pageResources" key="page.roleCompensate.awardCompensate.createAwardCompensate"/>" onclick="window.location.href='showCreatePointCompensate.do?changeType=${requestScope.changeType }'" />
				</td>
			</tr>
			</c:if>
			<c:if test="${requestScope.apprType == 'batchFirstApprPointCompensate' or requestScope.apprType == 'batchSecondApprPointCompensate' }">
			<tr height="30px">
				<td colspan="11" align="left">
