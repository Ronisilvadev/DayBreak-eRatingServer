...
<body bgcolor="#ffffff">
	<form action="<c:if test="${requestScope.oper == 'firstAppr' }">firstApprGoldCompensate.do</c:if>
		<c:if test="${requestScope.oper == 'secondAppr' }">secondApprGoldCompensate.do</c:if>" method="post">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr height="30px">
				<td align="center" colspan="2"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.roleCompensate.batchApprGoldCompensate.title"/></td>
			</tr>
			<tr height="23px">
