...
<head>
	...
	<html:javascript formName="/roleMoneyLog"/>
...
<body bgcolor="#ffffff">
	<c:if test="${empty requestScope.roleLog }">
		<html:form action="roleMoneyLog.do" method="post" onsubmit="return validateRoleMoneyLogForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.playerQuery.roleMoneyOperate.title"/></td>
			</tr>
			<tr height="30px">
				...
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleCompensate.paymoneyall.MONEYTYPE"/>：
				 ...
				 <td class="t_border_r" align="left">
				 	<select name="itemType">
				 		<c:forEach items="${requestScope.moneyList }" var="dic">
				 			<option value="${dic.opValue }">${dic.opValue } - ${dic.opText }</option>
				 		</c:forEach>
				 	</select>
				 </td>
	...
	<html:form action="roleMoneyLog.do" method="post" onsubmit="return validateRoleItemLogForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="20"><bean:message bundle="pageResources" key="page.playerQuery.roleMoneyOperate.title"/></td>
			</tr>
			<tr class="h_CDE4F6">
