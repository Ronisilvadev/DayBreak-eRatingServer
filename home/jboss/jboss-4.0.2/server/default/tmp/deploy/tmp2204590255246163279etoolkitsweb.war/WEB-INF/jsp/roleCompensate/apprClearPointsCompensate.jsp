...
<body bgcolor="#ffffff">
	<form action="<c:if test="${requestScope.oper == 'firstAppr' }">firstApprClearPointsCompensate</c:if>
		<c:if test="${requestScope.oper == 'secondAppr' }">secondApprClearPointsCompensate</c:if>.do" method="post">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr height="30px">
				<td align="center" colspan="2"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.roleCompensate.ClearPoints.title"/></td>
			</tr>
			<tr height="23px">
		...
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<c:if test="${not empty requestScope.ClearPointsCompensate }">
			<tr height="23px">
				<td align="center" class="t_border_l" width="30%"><bean:message bundle="pageResources" key="page.roleCompensate.ClearPoints.pointType"/>：</td>
				<td align="center" class="t_border_r">${requestScope.ClearPointsCompensate.pointType }</td>
			</tr>
			<tr height="23px">
				...
				<td align="center" class="t_border_r">${requestScope.ClearPointsCompensate.REASON }</td>
			</tr>
			<tr height="23px">
				...
				<td align="center" class="t_border_r">${requestScope.ClearPointsCompensate.OPERATOR_NAME }</td>
			</tr>
			<tr height="23px">
				...
				<td align="center" class="t_border_r">
					<gmweb:approvalResult2Text approvalResult="${requestScope.ClearPointsCompensate.APPROVAL_RESULT}" />
				</td>
			</tr>
			<tr height="10px">
			...
			<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<c:if test="${not empty requestScope.ClearPointsCompLogList }">
				<c:forEach items="${requestScope.ClearPointsCompLogList}" var="ClearPointsCompLog" varStatus="state">
				<tr height="23px">
						<td align="center" class="t_border_l">${state.index + 1 }</td>
						<td align="center" class="t_border_l">
							<gmweb:approvalNum2Text approvalNum="${ClearPointsCompLog.APPROVAL_NUM}" />
						</td>
						<td align="center" class="t_border_l">${ClearPointsCompLog.OPERATOR_NAME }</td>
						<td align="center" class="t_border_l"><fmt:formatDate value="${ClearPointsCompLog.APPROVAL_TIME}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						<td align="center" class="t_border_l">${ClearPointsCompLog.APPROVAL_COMMENT }</td>
						<td align="center" class="t_border_r">
							<gmweb:approvalResult2Text approvalResult="${ClearPointsCompLog.APPROVAL_RESULT}" />
						</td>
					</tr>
				</c:forEach>
				</c:if>
