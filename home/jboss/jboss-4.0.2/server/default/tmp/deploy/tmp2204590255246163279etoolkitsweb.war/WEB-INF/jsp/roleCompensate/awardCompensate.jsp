...
<html>
	...
	<head>
		...
		<script type="text/javaScript">
			...
			function ok (obj){
				if(confirm("确定删除")){
					window.location.href='deleteActivityAwardComp.do?compensateId='+obj+'';
				}else{
				    return false;
				}
			}
	...
	<body bgcolor="#ffffff">
		...
		<form name="pageForm" action="${requestScope.operType }.do" method="post">
			<table width="90%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr height="30px">
					<td colspan="7" align="left">
						<gmweb:createCompenTitleButton operType="${requestScope.operType}" actionName="roleCompensate" methodType="AwardCompensate" />
					</td>
				</tr>
				<tr>
				...
				<c:forEach items="${requestScope.pageInfo.infoList}" var="awardCompensate" varStatus="status">
					<tr height="23px">
						...
						<td align="center" class="t_border_r">
							<gmweb:createCompenOperLink operType="${requestScope.operType}" actionName="roleCompensate" methodType="AwardCompensate" compensateId="${awardCompensate.compensateId}"/>
			...
			<tr height="30px">
				<td colspan="7" align="left">
					<input type="button" value="<bean:message bundle="pageResources" key="page.roleCompensate.awardCompensate.createAwardCompensate"/>" onclick="window.location.href='showCreateAwardCompensate.do'" />
				</td>
			</tr>
			</c:if>
			<c:if test="${requestScope.apprType == 'batchFirstApprAwardCompensate' or requestScope.apprType == 'batchSecondApprAwardCompensate' }">
			<tr height="30px">
				<td colspan="7" align="left">
