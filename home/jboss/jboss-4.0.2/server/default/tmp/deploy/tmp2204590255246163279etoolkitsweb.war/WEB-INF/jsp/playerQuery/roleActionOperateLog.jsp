...
<head>
	...
	<script type="text/javascript">
		...
		function check(param){
			var gatewayId=document.getElementById("gatewayId");
			var roleName=document.getElementById("roleName");
			var actionType=document.getElementById("actionType");
			var startTime=document.getElementById("startTime");
			var endTime=document.getElementById("endTime");

			if(gatewayId.value.length==0){
				alert("<bean:message bundle='pageResources' key='page.common.gatewayId'/><bean:message bundle='pageResources' key='page.common.notnull'/>");
				return false;
			}
			if(roleName.value.length==0){
				alert("<bean:message bundle='pageResources' key='page.common.roleName'/><bean:message bundle='pageResources' key='page.common.notnull'/>");
				return false;
			}
			if(actionType.value.length==0){
				alert("<bean:message bundle='pageResources' key='page.common.actionType'/><bean:message bundle='pageResources' key='page.common.notnull'/>");
				return false;
			}
			if(startTime.value.length==0){
				alert("<bean:message bundle='pageResources' key='page.common.startDate'/><bean:message bundle='pageResources' key='page.common.notnull'/>");
				return false;
			}
			if(endTime.value.length==0){
				alert("<bean:message bundle='pageResources' key='page.worldOperation.common.endTime'/><bean:message bundle='pageResources' key='page.common.notnull'/>");
				return false;
			}
			
			return validateRoleActionOperateLogForm(param);
		}
	</script>
</head>
...
<body bgcolor="#ffffff">
	<c:if test="${empty requestScope.pageInfo }">
		<form action="getRoleActionOperateLog.do" method="post" onsubmit="return check(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.playerQuery.roleActionOperateLog.title"/></td>
			</tr>
			<tr height="30px">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.common.actionType"/>：
				 </td>
				 <td class="t_border_r" align="left">
	...
	<form action="getRoleActionOperateLog.do" method="post" onsubmit="return check(this);">
		...
		<tr>
			<td colspan="20" align="center" class="t_head"><bean:message bundle="pageResources" key="page.playerQuery.roleActionOperateLog.title"/> </td>
		</tr>
