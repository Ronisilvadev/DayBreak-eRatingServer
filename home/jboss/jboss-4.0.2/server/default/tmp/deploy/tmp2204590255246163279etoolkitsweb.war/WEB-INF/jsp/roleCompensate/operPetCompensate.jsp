...
<body bgcolor="#ffffff">
		...
		<gmweb:createCompenOperButton operType="${requestScope.oper}" actionName="roleCompensate" operatorName="${requestScope.petCompensate.operatorName}" passportName="${sessionScope.userInfo.passportName}" compensateId="${requestScope.compensateId}" methodType="PetCompensate" />
			...
			<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<tr>
					<td colspan="6" align="center" class="t_head"><bean:message bundle="pageResources" key="page.roleCompensate.operAwardCompensate.title2"/></td>
				</tr>
