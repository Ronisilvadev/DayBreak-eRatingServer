...
<body bgcolor="#ffffff">
	<c:if test="${empty requestScope.pageInfo }">
		<form action="showDelRole.do" method="post" onsubmit="return check();">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleOperation.common.roleName"/></td>
				 <td class="t_border_r" align="left">
				 	<input name="roleName" type="text" style="width:200px" /> <bean:message bundle="pageResources" key="page.roleOperation.common.roleDownLoad"/> 
				 </td>
			</tr>
			<tr height="30px">
