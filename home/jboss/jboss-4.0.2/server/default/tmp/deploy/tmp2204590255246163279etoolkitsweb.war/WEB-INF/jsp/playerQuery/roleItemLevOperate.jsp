...
<head>
	...
	<html:javascript formName="/roleItemLevLog"/>
...
<body bgcolor="#ffffff">
	<c:if test="${empty requestScope.roleLog }">
		<html:form action="roleItemLevLog.do" method="post" onsubmit="return validateRoleItemLevLogForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.playerQuery.roleItemLevOperate.title"/></td>
			</tr>
			<tr height="30px">
	...
	<html:form action="roleItemLevLog.do" method="post" onsubmit="return validateRoleItemLogForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="20"><bean:message bundle="pageResources" key="page.playerQuery.roleItemLevOperate.title"/></td>
			</tr>
			<tr class="h_CDE4F6">
			...
			<tr height="30px">
				<td class="t_border_r" style="border-bottom:#AEAEB0 1px solid;" align="right" colspan="20">
					...
					<c:if test="${requestScope.roleLog.page>1 }"><a href="#" onclick="nextPage('${requestScope.roleLog.page-1 }');"><bean:message bundle="pageResources" key="page.playerQuery.roleItemOperate.Front"/></a></c:if>
					<input type="text" style="width:21pt" name="toPage" id="toPage"/><a href="#" onclick="nextPage(document.getElementById('toPage').value);">GO</a>
					<a href="#" onclick="nextPage('${requestScope.roleLog.page+1 }');"><bean:message bundle="pageResources" key="page.playerQuery.roleItemOperate.next"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
