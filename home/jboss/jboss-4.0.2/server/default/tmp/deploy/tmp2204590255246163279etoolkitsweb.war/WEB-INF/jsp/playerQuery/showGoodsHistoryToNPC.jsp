...
<head>
	...
	<html:javascript formName="/GoodsHistoryToNPC"/>
</head>

<body bgcolor="#ffffff">
	<html:form action="GoodsHistoryToNPC.do" method="post" onsubmit="return validateGoodsHistoryToNPCForm(this);"> 
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.playerQuery.goodsHistoryToNPC.title"/></td>
			</tr>
			<tr height="30px">
