...
<head>
	...
	<title></title>
	<html:javascript formName="/addGameServer"/>
</head>


<body bgcolor="#ffffff">
	<html:form action="addGameServer.do" method="post" onsubmit="return validateGameServerForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30px"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.dictionaryConfig.addGameServer.title"/></td>
			</tr>
			<tr>
			...
			<tr height="30px">
				<td width="25%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.common.serverId2"/>：
				 ...
				 <td class="t_border_r" align="left">
				 	<input name="serverId" type="hidden" value="0" />0
				 </td>
			</tr>
			<tr height="30px">
