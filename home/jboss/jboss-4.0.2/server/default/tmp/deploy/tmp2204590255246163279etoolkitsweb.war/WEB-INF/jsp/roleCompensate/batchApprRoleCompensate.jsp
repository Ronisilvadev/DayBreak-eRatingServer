...
<body bgcolor="#ffffff">
	<form action="<c:if test="${requestScope.state == 1}">firstApprRoleCompensate.do</c:if>
		<c:if test="${requestScope.state == 2 }">secondApprRoleCompensate.do</c:if>" method="post">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr height="30px">
				<td align="center" colspan="2"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.roleCompensate.batchApprPenCompensate.title"/></td>
			</tr>
			<tr height="23px">
			...
			<tr height="30px">
				<td align="center" class="t_border_r" align="left" colspan="2">
					...
					<input type="hidden" name="compensateType" value="${requestScope.compensateType}" />
					<c:if test="${requestScope.state == 1}">
