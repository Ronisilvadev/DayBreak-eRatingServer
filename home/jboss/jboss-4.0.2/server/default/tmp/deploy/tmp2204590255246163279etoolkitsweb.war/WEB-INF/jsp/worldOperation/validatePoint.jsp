...
<html>
	...
	<body bgcolor="#ffffff">
		...
		<form action="addActivityPoint.do" method="post">
			<table width="90%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td colspan="5" align="center" class="t_head">
						<bean:message bundle="pageResources" key="page.worldOperation.validatePoint.title"/>
					</td>
				</tr>
				<tr height="23px" class="h_CDE4F6">
					...
					<td align="center" class="t_border_r">
						<bean:message bundle="pageResources" key="page.worldOperation.validatePoint.pointRate"/>
					</td>
			...
			<c:forEach items="${requestScope.arrChargeChannelId}" var="arrChargeChannelId"> 
			 ...
			 <input type="hidden" name="pointType" value="${ requestScope.pointType}" />
			 <input type="hidden" name="pointQuotiety" value="${ requestScope.pointQuotiety}" />
