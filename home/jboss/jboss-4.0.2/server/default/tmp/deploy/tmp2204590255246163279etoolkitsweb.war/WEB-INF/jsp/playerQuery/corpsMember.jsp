...
<body bgcolor="#ffffff">
	<c:if test="${not empty requestScope.gatewayList }">
		<form action="getCorpsMember.do" method="post" onsubmit="return validateCorpsDetailNewForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.playerQuery.corpsMember.title"/></td>
			</tr>
			<tr height="30px">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.common.corpsType"/>：
				 ...
				 <td class="t_border_r" align="left">
				 	<select name="corpsType" style="width:70px">				  		
	...
	<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
		...
		<tr>
			<td colspan="20" align="center" class="t_head"><bean:message bundle="pageResources" key="page.playerQuery.corpsMember.title"/> </td>
		</tr>
		<c:forEach items="${requestScope.corpsMemberList}" var="parentInfo">
			<tr height="23px">			
