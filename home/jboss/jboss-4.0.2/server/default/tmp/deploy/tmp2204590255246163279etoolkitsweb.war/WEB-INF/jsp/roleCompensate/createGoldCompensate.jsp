...
<head>
	...
	<script type="text/javaScript">
		function check(){
			...
			if ( document.forms[0].serialNumber.value == "" || document.forms[0].serialNumber.value  == null){
				  alert('<bean:message bundle="pageResources" key="page.roleCompensate.errors.serialNumber"/>');
				  document.forms[0].serialNumber.focus();
				  return false;
			}
			if ( document.forms[0].serialNumber.value.length != 12){
				  alert('<bean:message bundle="pageResources" key="page.roleCompensate.errors.serialNumberLength"/>');
				  document.forms[0].serialNumber.focus();
				  return false;
			}
			if ( document.forms[0].compensateContent.value == "" || document.forms[0].compensateContent.value  == null){
				  alert('<bean:message bundle="pageResources" key="page.roleCompensate.errors.compensateContent"/>');
				  document.forms[0].compensateContent.focus();
				  return false;
			}
			if ( document.forms[0].compensateContent.value.length > 4000){
				  alert('<bean:message bundle="pageResources" key="page.roleCompensate.errors.compensateContentLength"/>');
				  document.forms[0].compensateContent.focus();
				  return false;
			}
...
<body bgcolor="#ffffff">
	<form action="validateGoldCompensate.do" method="post" onsubmit="return check();">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="3"><bean:message bundle="pageResources" key="page.roleCompensate.createGoldCompensate.title"/></td>
			</tr>
			<tr height="30px">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleCompensate.createGoldCompensate.serialNumber"/>
				 </td>
				 <td class="t_border_r" align="left" colspan="2">
				 	<input name="serialNumber" type="text" value="${requestScope.serialNumber }" />
				 	<bean:message bundle="pageResources" key="page.roleCompensate.createGoldCompensate.serialNumberInfo"/>
				 </td>
			</tr>
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleCompensate.createGoldCompensate.compensateContent"/>
				 </td>
				 <td class="t_border_l" align="left">
				 	<textarea name="compensateContent" rows=8 cols=35 size="10240" >${requestScope.compensateContent }</textarea>
				 	
				 </td>
				 <td class="t_border_r" align="left">
				 <bean:message bundle="pageResources" key="page.roleCompensate.createGoldCompensate.compensateContentInfo"/><br />
					user1,50<br />
					user2,150
				</td>
			</tr>
