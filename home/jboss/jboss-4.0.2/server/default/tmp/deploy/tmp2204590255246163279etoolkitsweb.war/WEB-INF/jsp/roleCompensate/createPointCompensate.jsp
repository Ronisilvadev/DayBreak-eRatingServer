...
<head>
	...
	<script type="text/javaScript">
		...
		function check(){
				...
				if ( document.forms[0].point.value == "" || document.forms[0].point.value  == null){
					  alert('<bean:message bundle="pageResources" key="page.roleCompensate.errors.point1"/>' + '${requestScope.description}' + '<bean:message bundle="pageResources" key="page.roleCompensate.errors.point2"/>');
...
<body bgcolor="#ffffff">
	<form action="savePointCompensate.do?changeType=${requestScope.changeType }" method="post" onsubmit="return check();">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleCompensate.common.roleName"/>
				 ...
				 <td class="t_border_r" align="left" colspan="2">
				 	<input name="roleName" type="text" value="${requestScope.roleName }" />
				 </td>
			</tr>
			<tr height="30px">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right">${requestScope.description}<bean:message bundle="pageResources" key="page.roleCompensate.common.value"/>
				 </td>
				 <td class="t_border_r" align="left" colspan="2">
				 	<input name="point" type="text" value="${requestScope.point }" />
				 	<bean:message bundle="pageResources" key="page.roleCompensate.createPointCompensate.pointInfo"/>${requestScope.description}
				 </td>
			</tr>
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.roleCompensate.operAwardCompensate.reason"/>
				 </td>
				 ...
				 <bean:message bundle="pageResources" key="page.roleCompensate.apprAwardCompensate.approvalCommentLength"/>
				</td>
			</tr>
			<tr height="30px">
