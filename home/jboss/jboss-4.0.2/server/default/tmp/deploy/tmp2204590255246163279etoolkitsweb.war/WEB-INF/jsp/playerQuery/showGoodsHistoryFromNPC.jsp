...
<head>
	...
	<html:javascript formName="/GoodsHistoryFromNPC"/>
</head>

<body bgcolor="#ffffff">
	<html:form action="GoodsHistoryFromNPC.do" method="post" onsubmit="return validateGoodsHistoryFromNPCForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.playerQuery.showGoodsHistoryFromNPC.title"/></td>
			</tr>
			<tr height="30px">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.common.NPCName"/>：
				 </td>
				 <td class="t_border_r" align="left">
			...
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.common.startDate"/>：
				 ...
				 <td class="t_border_r" align="left">
				 	<input name="startDate" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="<fmt:formatDate value="${requestScope.startDate }" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
				 </td>
			</tr>
			<tr height="30px">
				<td width="35%" class="t_border_l" align="right"><bean:message bundle="pageResources" key="page.common.endDate" />：
				 ...
				 <td class="t_border_r" align="left">
				 	<input name="endDate" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="<fmt:formatDate value="${requestScope.endDate }" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
				 </td>
			</tr>
			<tr height="30px">
