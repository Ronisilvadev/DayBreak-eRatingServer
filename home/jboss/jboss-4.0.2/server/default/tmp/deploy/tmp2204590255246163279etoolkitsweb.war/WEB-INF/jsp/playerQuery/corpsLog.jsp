...
<body bgcolor="#ffffff">
	<c:if test="${empty requestScope.pageLog }">
		<form action="getCorpsLog.do" method="post" onsubmit="return validateCorpsLogForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30PX"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.playerQuery.corpsLog.title"/></td>
			</tr>
			<tr height="30px">
	...
	<c:if test="${not empty requestScope.pageLog }">
	<html:form action="getCorpsLog.do" method="post" onsubmit="return validateCorpsLogForm(this);">		
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr height="30px">
			<td colspan="20" align="center" ></td>
		</tr>
		<tr>
			<td colspan="20" align="center" class="t_head"><bean:message bundle="pageResources" key="page.playerQuery.corpsLog.title"/> </td>
		</tr>
		<c:forEach items="${requestScope.pageLog.list}" var="parentInfo">
			<tr height="23px">			
		...
		<tr height="30px">
				<td class="t_border_r" style="border-bottom:#AEAEB0 1px solid;" align="right" colspan="20">
					...
					<input type="hidden" name="corpsName" value="${corpsName }"/>
					<input type="hidden" name="corpsType" value="${corpsType }"/>
