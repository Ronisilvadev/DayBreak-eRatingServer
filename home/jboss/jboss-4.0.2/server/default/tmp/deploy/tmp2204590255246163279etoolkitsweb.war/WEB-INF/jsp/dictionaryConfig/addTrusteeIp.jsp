...
<head>
	...
	<title></title>
	<html:javascript formName="/addTrusteeIp"/>
</head>


<body bgcolor="#ffffff">
	<html:form action="addTrusteeIp.do" method="post" onsubmit="return validateTrusteeIpForm(this);">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			<tr>
				<td align="center" height="30px"></td>
			</tr>
			<tr>
				<td align="center" class="t_head" colspan="2"><bean:message bundle="pageResources" key="page.dictionaryConfig.addTrusteeIp.title"/></td>
			</tr>
			<tr>
