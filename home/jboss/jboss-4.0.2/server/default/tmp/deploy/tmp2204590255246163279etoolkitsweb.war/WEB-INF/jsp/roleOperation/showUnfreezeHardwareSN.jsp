...
<body bgcolor="#ffffff">	
	<form action="unfreezeHardwareSN.do" method="post" onsubmit="return check();">
		<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				<td align="center" class="t_head" colspan="3">
					<bean:message bundle="pageResources" key="page.roleOperation.hardwareSN.unfreezeHardwareSN"/>
				</td>
			</tr>
			...
			<tr height="30px">
				<td class="t_border" style="border-bottom:#AEAEB0 1px solid;" align="center"  colspan="3">
					<input name="query" type="submit" value="<bean:message bundle="pageResources" key="page.roleOperation.hardwareSN.beginUnfreeze"/>" />
				</td>
			</tr>			
		</table>
	</form>
