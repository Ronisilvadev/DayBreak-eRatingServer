...
insert into SYS_OPTION_INFO values('original_role_name',   '0',        '禁用');
insert into SYS_OPTION_INFO values('original_role_name',   '1',        '启用');
...
insert into SYS_OPTION_INFO values('role_dup_ret_true',    '0',        '否');
insert into SYS_OPTION_INFO values('role_dup_ret_true',    '1',        '是');
