...
(
   game_id              integer not null comment '游戏ID',
   user_id              integer not null comment '玩家的唯一ID号。来源于SYS_PASSPORT中的passport_id。',
...
(
   ...
   use_user_id          integer not null comment '被激活帐号ID。',
...
(
   user_id              bigint unsigned not null auto_increment comment '联运方user_id',
   primary key (user_id)
)
...
(
   game_id              integer not null comment '游戏ID',
   user_id              integer not null comment '帐号ID。',
