...
libmysql/libmysqlclient_r.so.18.0.0: libmysql/libmysqlclient.so
	...
	cd /opt/mysql-5.5.15/libmysql && /usr/local/cmake/bin/cmake -E remove -f /opt/mysql-5.5.15/libmysql/libmysqlclient_r.so.18.0.0
	cd /opt/mysql-5.5.15/libmysql && /usr/local/cmake/bin/cmake -E create_symlink libmysqlclient.so libmysqlclient_r.so.18.0.0
...
libmysql/CMakeFiles/symlink_libmysqlclient_r.so.18.0.0.dir/clean:
	cd /opt/mysql-5.5.15/libmysql && $(CMAKE_COMMAND) -P CMakeFiles/symlink_libmysqlclient_r.so.18.0.0.dir/cmake_clean.cmake
...
libmysql/CMakeFiles/symlink_libmysqlclient_r.so.18.0.0.dir/depend:
	cd /opt/mysql-5.5.15 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/mysql-5.5.15 /opt/mysql-5.5.15/libmysql /opt/mysql-5.5.15 /opt/mysql-5.5.15/libmysql /opt/mysql-5.5.15/libmysql/CMakeFiles/symlink_libmysqlclient_r.so.18.0.0.dir/DependInfo.cmake --color=$(COLOR)
