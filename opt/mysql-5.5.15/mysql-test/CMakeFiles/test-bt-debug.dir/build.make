...
mysql-test/CMakeFiles/test-bt-debug:
	...
	cd /opt/mysql-5.5.15/mysql-test && perl ./mysql-test-run.pl --force --comment=debug --timer --skip-ndbcluster --skip-rpl --report-features --experimental=collections/default.experimental
...
mysql-test/CMakeFiles/test-bt-debug.dir/clean:
	cd /opt/mysql-5.5.15/mysql-test && $(CMAKE_COMMAND) -P CMakeFiles/test-bt-debug.dir/cmake_clean.cmake
.PHONY : mysql-test/CMakeFiles/test-bt-debug.dir/clean

mysql-test/CMakeFiles/test-bt-debug.dir/depend:
	cd /opt/mysql-5.5.15 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/mysql-5.5.15 /opt/mysql-5.5.15/mysql-test /opt/mysql-5.5.15 /opt/mysql-5.5.15/mysql-test /opt/mysql-5.5.15/mysql-test/CMakeFiles/test-bt-debug.dir/DependInfo.cmake --color=$(COLOR)
