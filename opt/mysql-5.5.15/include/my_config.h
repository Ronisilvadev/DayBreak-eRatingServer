...
#define DEFAULT_MYSQL_HOME "/usr/local/mysql5.5.15"
#define SHAREDIR "/usr/local/mysql5.5.15/share"
#define DEFAULT_BASEDIR "/usr/local/mysql5.5.15"
#define MYSQL_DATADIR "/usr/local/mysql5.5.15/data"
#define DEFAULT_CHARSET_HOME "/usr/local/mysql5.5.15"
#define PLUGINDIR "/usr/local/mysql5.5.15/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/mysql5.5.15/etc"
